...
const aliensImg = ['resources/img/monster1.png', 'resources/img/monster2.png', 'resources/img/monster3.png'];
...
function createLaserElement() {
    ...
    newLaser.src = 'resources/img/laser.png';
    ...
    let laserInterval = setInterval(() => {
        ...
        aliens.forEach((alien) => {
            if(checkLaserCollision(laser, alien)) {
                alien.src = 'resources/img/explosion.png';
